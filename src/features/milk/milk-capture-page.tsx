  ...
  return <>
    <div className="space-y-5 pb-24">
      ...
      <Card>
        ...
        <section className="mt-5"><label htmlFor="milk-measurement-value" className="px-1 text-xs font-bold uppercase tracking-[0.14em] text-stone-500">Litros entregados</label><div className="relative mt-2"><TextInput id="milk-measurement-value" autoFocus className="min-h-28 border-2 border-lime-300 bg-white px-5 pr-20 !text-6xl !leading-none font-black tracking-tight placeholder:text-stone-300 focus:border-lime-700 sm:!text-7xl" inputMode="decimal" min="0" step="0.1" type="number" value={value} onChange={(event) => setValue(event.target.value)} placeholder="0.0" /><span className="pointer-events-none absolute right-5 top-1/2 -translate-y-1/2 text-2xl font-black text-stone-500">L</span></div></section>
